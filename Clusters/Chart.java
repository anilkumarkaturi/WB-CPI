...
private static CategoryDataset createDataset(){
	...
	for(int i=0;i<MainScreen.graph.size();i++) {
		String data[] = MainScreen.graph.get(i).split(",");
		localDefaultCategoryDataset.addValue(Double.parseDouble(data[1]), data[0], data[0]);
	}
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Predicted Crop Name", "Crop Growth", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
